...
@include ('layouts.nav')
    ...
    <div id="page-wrapper">
        ...
        ?>
            ...
            <a href="/resetPassword/{{$id}}"><button class="btn btn-primary btn-sm" onclick="<?php

                ?>" style="position: absolute; top: 15%; left:37%; padding: 6px 15px 6px 15px;">Reset Password</button></a>
