        ...
        <div class="container-fluid">
            ...
            <div class="white-box" style="width: 85%; margin: 0 auto; height: 350px;">
                <div style=" margin:0 auto; width:85%;">
                    <h4 style="text-align: center; font-size: 130%; letter-spacing:3px; border-bottom-style: solid"> Open a Subject </h4>
                    ...
                    <form method="post" action="/subjectManagement/{{$sub}}">
                        ...
                        <select class="form-control row b-none" name="cour" id="cour" style="width: 20%; position: absolute; margin-top: 0; margin-left: 2%; font-size: 120%; ">
                            <?php
