...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div style="position: absolute; text-align: center; margin: 10px auto; width: 90%;">
                <h2 style="text-align: center; margin-left: 15%; margin-right: 20%; margin-top:1%; border-style: dashed; border-width:3px">Pre-enroll a Student</h2>
                <h3 style="text-align: left; margin-left: 20%; margin-top: 2%">Search for ID Number: </h3>
                <form role="search" class="app-search hidden-xs" method="post" action="/search/">
                    {{ csrf_field() }}
                    <input type="text" placeholder="..." class="form-control" name="search" value="" style="width: 40%; height: 60%; color: black; font-size: 120%">
