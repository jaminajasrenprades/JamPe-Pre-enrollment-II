                        ...
                        <div class="white-box" style="overflow-y:scroll; height: 500px;">
                            ...
                            <?php
                                $subj = DB::table('petitions')
                                    ...
                                    ->select(array('petitions.subjectID', 'subjects.coursenumber', 'subjects.destitle', 'subjects.units', DB::raw('COUNT(petitions.subjectID) as count')))
                                ...
                                @foreach($subjs as $subjs)
                                        <a href="/petitions">
                                            <div class="mail-content">
                                                <h5>{{ $subj-> coursenumber }} -- {{ $subj->destitle }} -- {{ $subj->units }} Units </h5>
